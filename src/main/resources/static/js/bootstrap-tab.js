(function ($, window, document, undefined) {
	...
	BaseTab.prototype.template = {
		ul_nav: '<ul id="myTab"  class="nav nav-tabs pa-4"></ul>',
		ul_li: '<li class="nav-item"  style="float:right;"><a class="nav-link" href="#{0}" data-toggle="tab"><span>{1}</span></a></li>',
		ul_li_close: '<div class="wrapDel" style="float:right;"><i class="fa fa-trash-o closeable" title="关闭页面"></i></div>',
	...
	BaseTab.prototype.getCurrentTabId=function () {
		var href=this.$element.find(".nav-tabs li a.nav-link.active").attr("href");
