...
(function ($) {
	$.fn.nthTabs =  function(options){
		...
		var template = '<div class="page-tabs"><div class="content-tabs"><div class="content-tabs-container"><ul class="nav nav-tabs"></ul></div></div><div class="dropdown roll-nav right-nav-list"></div></div><div class="tab-content"></div>';
		//各种api
		var methods = {
			//初始化
			init:function () {
			...
			addTabs:function (options) {
				...
				active = active ? 'nav-item active':'nav-item';
				tab.push('<li class="'+active+'">');
				tab.push('<a class="nav-link" href="#'+options.id+'" data-toggle="tab">');
