...
import com.programme.Fortress.Function.Business.service.PayInterposeService;
...
public class PayInterposeAction {
    ...
    @ResponseBody
    public Object addPayInterpose(@RequestBody PayInfor payInfor){
        return payInterposeService.addPayInterpose(payInfor);
    }
    ...
    @ResponseBody
    public String getPayInterpose(@RequestBody PayInfor payInfor){
        ...
        ReturnData<PayInterpose> payInforList = payInterposeService.getPayInterpose(payInfor);
