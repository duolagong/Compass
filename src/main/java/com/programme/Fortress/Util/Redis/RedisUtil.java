...
public class RedisUtil {
     ...
     * @return
     */
    public double zAdd(String key, String item, double value) {
     ...
     * @return
     */
    public Object zItemGet(String key, String item){
        try {
